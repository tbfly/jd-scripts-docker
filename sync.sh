...
(
  ...
  git clone https://github.com.cnpmjs.org/tbfly/jd-scripts-docker.git /jd-scripts-docker_tmp
...
(
  ...
  git clone --branch=master https://github.com.cnpmjs.org/aike-jd/jd_scripts.git /scripts_tmp
  [ -d /scripts_tmp ] && {
    rm -rf /scripts
